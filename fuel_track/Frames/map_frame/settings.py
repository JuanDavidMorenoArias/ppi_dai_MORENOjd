...
# image paths 
map_image_path = 'Frames/map_frame/images/map.png'
paint_image_path = 'Frames/map_frame/images/paint.png'
terrain_image_path = 'Frames/map_frame/images/terrain.png'